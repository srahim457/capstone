...
Item.createItem = async function (req, res) {
  try {
    ...
    const item = await sql.query('INSERT INTO guilds.item_info (item_name,item_desc,image,is_available) VALUES($1,$2,$3,$4)', [req[0].item_name, req[0].item_desc, req[0].item_image, req[0].is_available])
